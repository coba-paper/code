...
axes.set_xticks(list(final_auc["param"].unique()))

axes.set_xlabel("${|\mathcal{D}_L|}\ / \ {|val(\mathcal{C}^A \\times X)|}$")
...
# %%
fig = axes.get_figure()
fig.savefig(f"Experiment5.png", bbox_inches="tight")
