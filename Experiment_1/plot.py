...
EXPERIMENT_OPT_REWARDS = [2+1/3, 2.2, 2.8, 4, 3.4]
...
# %%
num_runs_per_B = NUM_RUNS_PER_B/5
...
def get_regret(experiment_name, opt_reward):
    ...
    df_new_regret["regret"] = df_new_regret["regret"]/df_new_regret["regret"].max()
...
axes.set_ylabel("Regret (normalized)")
